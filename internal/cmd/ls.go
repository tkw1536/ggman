...
func NewLsCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `
While creating a folder structure for cloning new repositories, ggman can run operations on any other folder structure contained within the GGROOT directory. 
